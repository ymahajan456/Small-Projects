function h_fir = Bandpass_FIR(ws1, wp1, wp2, ws2, dp, ds, samp)
	...
	h_ideal = (sin(wc2 * n) - sin(wc1 * n))./(pi * n);
	h_ideal(N + 1) = (wc2-wc1)/pi;
	...
	plot_z_transfer(h_fir, samp, M-1, 'Bandpass-FIR');
end