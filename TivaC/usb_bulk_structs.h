...
extern tUSBBuffer g_sTxBuffer;   //buffer objects
extern tUSBBuffer g_sRxBuffer;
extern tUSBDBulkDevice g_sBulkDevice;   // device object
extern uint8_t g_pui8USBTxBuffer[];    // Tx Buffer Array
extern uint8_t g_pui8USBRxBuffer[];    // Rx Buffer Array
